          ...
          <div className="mx-auto max-w-[1240px]">
            <div className="grid gap-12 lg:grid-cols-2">
              <div>
                ...
                <h2 className="font-display text-2xl leading-tight text-brand-ink sm:text-[28px]">
                  Why we do what we do
                </h2>
                <p className="mt-4 text-[15.5px] leading-relaxed text-brand-steel">
                  {aboutContent.story}
                </p>
              </div>
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              {aboutContent.values.map((value) => (
                ...
                >
                  ...
                  <p className="text-[14.5px] text-brand-ink-soft">{value}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section id="why-us" className="px-6 py-[90px]">
          <div className="mx-auto max-w-[1240px]">
            <div className="mb-12 max-w-[620px]">
              ...
              <h2 className="font-display text-2xl leading-tight text-brand-ink sm:text-[28px]">
                What sets Kemi Communications apart
              </h2>
            </div>
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {aboutContent.whyUs.map((item) => (
                ...
                >
                  <h3 className="mb-2 text-[15px] font-semibold text-brand-ink">
                    {item.title}
                  </h3>
